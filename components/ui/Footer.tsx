      ...
      <div className="max-w-6xl w-full mx-auto px-4 py-8 sm:py-12">
        <div className="flex flex-col gap-8 sm:gap-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-center sm:text-left">
            <p className="-tracking-wide text-sm sm:text-base text-balance max-w-sm mx-auto sm:mx-0">
              Focused on scalability, clean architecture, and developer
              experience
            </p>
            <h3 className="text-xl sm:text-2xl font-semibold order-first sm:order-last">
              @rynrama_
            </h3>
          </div>
